...
class Movie(Base):
    ...
    credits_synced_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    trailer_provider: Mapped[str] = mapped_column(String(32), default="")
    trailer_key: Mapped[str] = mapped_column(String(128), default="")
    trailer_title: Mapped[str] = mapped_column(String(255), default="")
    trailer_official: Mapped[bool] = mapped_column(Boolean, default=False)
    trailer_language: Mapped[str] = mapped_column(String(16), default="")
    trailer_published_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    has_demo_clip: Mapped[bool] = mapped_column(Boolean, default=False)
    ...
    submitted_for_review_by: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    unpublished_by: Mapped[int | None] = mapped_column(Integer, nullable=True)
    archived_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    archived_by: Mapped[int | None] = mapped_column(Integer, nullable=True)
    publication_version: Mapped[int] = mapped_column(Integer, default=0)
    publication_reason: Mapped[str | None] = mapped_column(Text, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow, onupdate=utcnow)
...
class Episode(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("series_id", "tmdb_id", name="uq_episodes_series_tmdb_id"),
    )
    ...
    metadata_source: Mapped[str] = mapped_column(String(32), default="")
    demo_owned: Mapped[bool] = mapped_column(Boolean, default=False)
    demo_seed_version: Mapped[str] = mapped_column(String(32), default="")
    imported_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    metadata_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    has_demo_clip: Mapped[bool] = mapped_column(Boolean, default=False)
