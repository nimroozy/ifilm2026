"""Resolve a playable media asset (active HLS package or validated external URL)."""
...
def get_playable_asset_for_content(
    ...
    """Map catalog movie/episode id → playable media asset (package or external)."""
    ...
    external = external_q.order_by(MediaAsset.updated_at.desc()).first()
